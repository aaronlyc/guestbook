...
// WebappV1Client is used to interact with features provided by the webapp.example.org group.
type WebappV1Client struct {
	restClient rest.Interface
}

func (c *WebappV1Client) Guestbooks(namespace string) GuestbookInterface {
	return newGuestbooks(c, namespace)
}
